...
<dom-module id="wit-example-viewer">
  <template>
    <style id="linter-paper-button-style">
      /**
       * This style preserves the styling previous to
...
<dom-module id="wit-inference-viewer">
  <template>
    <style>
      :host {
        display: block;
    ...
    <paper-dialog id="distancedialog">
      ...
      <template is="dom-if" if="[[!shouldHideCounterfactualValueSelector_(attributions, customDistanceFunctionSet)]]">
        ...
        <paper-radio-group class="dist-switch" selected="{{distanceValueSwitch}}">
          <paper-radio-button class="dist-radio" name="values">Feature values</paper-radio-button>
          <paper-radio-button class="dist-radio" name="attribution">Attributions</paper-radio-button>
        </paper-radio-group>
      </template>
        ...
        <div class="main-content">
          <div class="main-bottom-bar">
            ...
            <div class="datapoint-right-controls-holder">
              <a target="_blank" class="control" href="https://github.com/pair-code/what-if-tool/tree/master/README.md" rel="noopener noreferrer">
                    ...
                    <iron-collapse class="no-padding-card" id="collapsecontexttools" opened="{{openedContextTools}}">
                      ...
                      <div class="flex-wrap">
                        ...
                        <paper-radio-group selected="{{nearestCounterfactualDist}}">
                          ...
                          <paper-radio-button name="Custom" hidden$="[[!customDistanceFunctionSet]]">Custom distance</paper-radio-button>
                        </paper-radio-group>
                        <paper-dropdown-menu label="Calculate using:" no-label-float class="short-dropdown" hidden$="[[shouldHideCounterfactualValueSelector_(attributions, customDistanceFunctionSet)]]">
                          <paper-listbox class="dropdown-content" slot="dropdown-content" selected="{{nearestCounterfactualValueIndex}}">
                      ...
                      <div title="Select a datapoint to use this feature">
                        <div class="flex">
                          <paper-button class="control-button datapoint-button" disabled$="[[!hasSelected(selectedExampleAndInference)]]" on-tap="showDistanceClicked_" alt="Create similarity feature" title="Creates a feature that shows similarity to selected datapoint">
                          ...
                          <div class="flex" hidden="[[!hasAttributions_(attributions)]]">
                            ...
                            <paper-dropdown-menu label="Feature sort order" class="short-dropdown" no-label-float>
                              <paper-listbox slot="dropdown-content" selected="{{exampleFeatureSortOrder}}" attr-for-selected="name">
                                <paper-item name="alphabetical">Alphabetical by features</paper-item>
                                <paper-item name="attribution">Descending attribution</paper-item>
                                <paper-item name="reverse-attribution">Ascending attribution</paper-item>
                                <paper-item name="absolute-attribution">Absolute attribution</paper-item>
                              </paper-listbox>
                            </paper-dropdown-menu>
                  ...
                  <div class="inference-section-holder">
                    <div class="inference-section">
                      ...
                      <iron-collapse class="no-padding-card" id="collapseinference" opened="{{openedInferenceResults}}">
                        ...
                        <div class="flex">
                          <template is="dom-if" if="[[hasSelected(selectedExampleAndInference)]]">
                            <wit-inference-viewer class="inference-viewer" inferences="[[selectedExampleAndInference.inferences]]" id$="[[getInferenceHolderId_()]]" model-type="[[modelType]]" model-names="[[parsedModelNames]]" max-entries-per-run="[[maxInferenceEntriesPerRun]]">
                            </wit-inference-viewer>
                          </template>
                          <template is="dom-if" if="[[counterfactualExampleAndInference]]">
                            <wit-inference-viewer class="inference-viewer compare-inference-viewer" inferences="[[counterfactualExampleAndInference.inferences]]" model-type="[[modelType]]" model-names="[[parsedModelNames]]" max-entries-per-run="[[maxInferenceEntriesPerRun]]">
                            </wit-inference-viewer>
                          </template>
                        </div>
                      </iron-collapse>
                ...
                <div class="feature-container-holder" id="partialplotholder">
                  <div class="pd-plots-header">
                    ...
                    <div class="button-and-progress-holder">
                      <paper-button class="control-button datapoint-button" disabled$="[[shouldDisableSortFeaturesButton(partialDepPlotEligibleFeatures, isSortingEligibleFeatures)]]" on-tap="sortPdFeatures_" alt="Sort by variation" title="Sort by variation">
                      Sort by variation
                      </paper-button>
                        ...
                        <div class="pd-entry-container perf-table-entry-expanded" hidden>
                          <div class="pd-input-container" hidden$="[[shouldHidePdInputContainer(item, selected)]]">
                            <div class="range-input-container" hidden$="[[item.samples]]">
                              <div class="info-text" title="set a range of values to visualize in the partial dependence plot(default values are automatically inferred)." alt="set a range of values to visualize in the partial dependence plot">
                    ...
                    <template is="dom-repeat" items="[[featureValueThresholds]]" as="featureValueThreshold">
                      <div class="perf-table-entry">
                        <div class$="[[getPerfTableRowClass(featureValueThreshold.opened)]]" data-index$="[[index]]">
                          ...
                          <div class="perf-table-val perf-table-clickable perf-table-text-entry feature-name-text" on-tap="togglePerfRow">
                      ...
                      <iron-collapse opened="{{featureValueThreshold.opened}}">
                        <div class="perf-table-entry-expanded flex-row-reverse">
                          <template is="dom-if" if="[[shouldShowFeaturePerfAttributionCharts_(selectedLabelFeature, selectedBreakdownFeature, inferences, attributions)]]">
                            <div class="perfs-holder">
                              <template is="dom-if" if="[[shouldShowFeaturePerfCharts_(selectedLabelFeature, selectedBreakdownFeature, inferences, attributions)]]">
                                ...
                                <div class="perf-holder">
                                  <div class="flex">
                                    ...
                                    <paper-icon-button icon="info-outline" class="info-icon mean-attrs-info-icon no-padding" on-tap="openDialog">
                                    </paper-icon-button>
                                    <paper-dialog class="dialog-text" horizontal-align="auto" vertical-align="auto">
                                      <div class="dialog-title">
                                          Confusion Matrix
                                  ...
                                  <template is="dom-repeat" items="{{featureValueThreshold.threshold}}">
                                    <wit-confusion-matrix counts="[[getConfusionCountsModelIndex(inferenceStats_, featureValueThreshold.threshold, index, featureValueThreshold)]]" label="[[getConfusionMatrixLabel(index, numModels)]]" background="[[getConfusionMatrixColor(index)]]" all-items="[[allConfMatrixLabels]]">
                                    </wit-confusion-matrix>
                                  </template>
                                </div>
                              </template>
                              <template is="dom-if" if="[[hasAttributions_(attributions)]]">
                                <div class="perf-holder">
                                  ...
                                  <wit-attribution-table attributions="[[getFacetedAttributions(facetedMeanAttributions_, featureValueThreshold)]]" models="[[parsedModelNames]]" colors="[[attributionColorScale]]" text-color-function="[[attributionTextColorFunction]]">
                    ...
                    <template is="dom-if" if="[[shouldShowOverallThresholder_(selectedBreakdownFeature)]]">
                      <div class="perf-table-entry">
                        <div class="perf-table-row-expanded">
                          <div class="perf-table-arrow">
                            <paper-icon-button icon="arrow-drop-down" on-tap="togglePerfRow" class="normal-icon" disabled></paper-icon-button>
                          </div>
                      ...
                      <div class="perf-table-entry-expanded flex-row-reverse">
                        <template is="dom-if" if="[[shouldShowOverallPerfAttributionCharts_(selectedLabelFeature, selectedBreakdownFeature, inferences, attributions)]]">
                          <div class="perfs-holder">
                            <template is="dom-if" if="[[shouldShowOverallPerfCharts_(selectedLabelFeature, selectedBreakdownFeature, inferences, attributions)]]">
                              <div class="perf-holder">
                                <div class="perf-curve-text">
                              ...
                              <div class="perf-holder">
                                ...
                                <template is="dom-repeat" items="{{overallThresholds}}">
                                  <wit-confusion-matrix counts="[[getConfusionCountsModelIndex(inferenceStats_, overallThresholds, index)]]" label="[[getConfusionMatrixLabel(index, numModels)]]" background="[[getConfusionMatrixColor(index)]]" all-items="[[allConfMatrixLabels]]">
                                  </wit-confusion-matrix>
                                </template>
                              </div>
                            </template>
                            <template is="dom-if" if="[[hasAttributions_(attributions)]]">
                              <div class="perf-holder">
                                ...
                                <wit-attribution-table attributions="[[meanAttributions_]]" models="[[parsedModelNames]]" colors="[[attributionColorScale]]" text-color-function="[[attributionTextColorFunction]]">
                                </wit-attribution-table>
                              </div>
                            </template>
                          </div>
                            ...
                            <div class="perfs-holder">
                              <div class="perf-holder">
                                ...
                                <template is="dom-repeat" items="[[inferenceStats_]]" as="inferenceStat">
                                  <wit-confusion-matrix counts="[[getMultiClassConfMatrix(inferenceStats_, index, featureValueThreshold)]]" label="[[getConfusionMatrixLabel(index, numModels)]]" background="[[getConfusionMatrixColor(index)]]" all-items="[[allConfMatrixLabels]]">
                                  </wit-confusion-matrix>
                                </template>
                              </div>
                            </div>
                        ...
                        <template is="dom-if" if="[[shouldShowOverallPerfCharts_(selectedLabelFeature, selectedBreakdownFeature, inferences)]]">
                          <div class="perfs-holder">
                            <div class="perf-holder">
                              ...
                              <template is="dom-repeat" items="[[inferenceStats_]]" as="inferenceStat">
                                <wit-confusion-matrix counts="[[getMultiClassConfMatrix(inferenceStats_, index)]]" label="[[getConfusionMatrixLabel(index, numModels)]]" background="[[getConfusionMatrixColor(index)]]" all-items="[[allConfMatrixLabels]]">
                                </wit-confusion-matrix>
                              </template>
                            </div>
                          </div>
                      ...
                      <div class="regression-perf-table-entry">
                        ...
                        <template is="dom-if" if="[[hasAttributions_(attributions)]]">
                          <div class="regression-attr-holder">
                            ...
                            <wit-attribution-table attributions="[[getRegressionAttributions(item.name)]]" models="[[parsedModelNames]]" colors="[[attributionColorScale]]" text-color-function="[[attributionTextColorFunction]]">
                            </wit-attribution-table>
                          </div>
                        </template>
                      </div>
...
<body>
  <wit-dashboard></wit-dashboard>
<script src="wit_tb_bin.js"></script>